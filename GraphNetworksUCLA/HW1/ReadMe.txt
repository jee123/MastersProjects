...
1) Please make sure R is installed on the machine.
2) Open terminal.
3) Go in the directory where the script has been saved.
4) Run the below command in order.

	chmod 777 HW1_104588717_904588105_004589213.R
	./HW1_104588717_904588105_004589213.R

Windows :

1) Please make sure R and igraph are installed on the machine.
2) Open RStudio.
3) Open the script (HW1_104588717_904588105_004589213.R) in RStudio.
4) Run the code.
