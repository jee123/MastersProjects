...
train = json.load(open('/mnt/sdd/tests1/Kaggle/whats-cooking/data/train.json'))
test = json.load(open('/mnt/sdd/tests1/Kaggle/whats-cooking/data/test.json'))
...
submission_df.to_csv('/mnt/sdd/tests1/Kaggle/whats-cooking/submission/svm_submission.csv', index=False)
