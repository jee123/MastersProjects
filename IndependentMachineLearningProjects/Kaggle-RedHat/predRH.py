...
act_train_data = pd.read_csv("/Users/tjee/Documents/projectsMS/IndependentMachineLearningProjects/Kaggle-RedHat/input/act_train.csv",dtype={'people_id': np.str, 'activity_id': np.str, 'outcome': np.int8}, parse_dates=['date'])
act_test_data  = pd.read_csv("/Users/tjee/Documents/projectsMS/IndependentMachineLearningProjects/Kaggle-RedHat/input/act_test.csv", dtype={'people_id': np.str, 'activity_id': np.str}, parse_dates=['date'])
people_data    = pd.read_csv("/Users/tjee/Documents/projectsMS/IndependentMachineLearningProjects/Kaggle-RedHat/input/people.csv", dtype={'people_id': np.str, 'activity_id': np.str, 'char_38': np.int32}, parse_dates=['date'])
...
output.head()
output.to_csv('/Users/tjee/Documents/projectsMS/IndependentMachineLearningProjects/Kaggle-RedHat/without_leak.csv', index = False)
